...
* [x] **Proteção de Territórios Sensíveis:** Integração de Terras Indígenas (FUNAI) e Territórios Quilombolas (INCRA) para bloqueio automático de originação em áreas de conflito.
