...
class DeforestationMetrics(BaseModel):
    ...
    # NOVOS CAMPOS PARA AUDITORIA OFICIAL
...
class SocialScore(BaseModel):
    ...
    # protected_overlap_ha removido (redundante)
...
class RiskAnalysis(BaseModel):
    ...
    # NOVO CAMPO DE SCORE DE ADJACÊNCIA
