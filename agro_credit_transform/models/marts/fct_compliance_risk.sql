...
final_formatting AS (
    SELECT 
        *,
        -- Nível de Confiança Geoespacial
        CASE 
        ...
        -- Consolidação de evidências técnicas para o laudo
        ...
        -- Detalhamento do status para auditoria rápida
...
SELECT
    ...
    logistics_risk_level, logistics_risk_score, is_structured_environmental_risk,
    count_artificial_water_bodies, artificial_water_details,
    has_physical_barrier, adjacent_rivers, critical_contact_point,
    data_source_quality,
    ti_overlap_pct, uc_overlap_pct, settlement_overlap_pct, traditional_overlap_pct,
