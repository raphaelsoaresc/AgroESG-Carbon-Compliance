{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/obscuritenoir/Portfolio/AgroESG-Carbon-Compliance/agro_credit_transform";
  project_input_ref = "path:/home/obscuritenoir/Portfolio/AgroESG-Carbon-Compliance/agro_credit_transform";
  devenv_dotfile = "/home/obscuritenoir/Portfolio/AgroESG-Carbon-Compliance/agro_credit_transform/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-68ebf35";
  ...
  hostname = "gnome";
  username = "obscuritenoir";
  git_root = "/home/obscuritenoir/Portfolio/AgroESG-Carbon-Compliance";
  secretspec = null;
};
    in
    {
